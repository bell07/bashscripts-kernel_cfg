...
wget 'https://raw.githubusercontent.com/evlaV/jupiter/refs/heads/main/linux-neptune-618/config-neptune' -O "$APPL_DIR"/cfg/30_enable_steamdeck_device.config.new
...
wget 'https://raw.githubusercontent.com/projg2/fedora-kernel-config-for-gentoo/6.19.11-gentoo/kernel-x86_64-fedora.config' -O "$APPL_DIR"/distro/gentoo-fedora-x86_64.config
