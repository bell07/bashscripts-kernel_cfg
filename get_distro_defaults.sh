...
wget 'https://raw.githubusercontent.com/projg2/fedora-kernel-config-for-gentoo/6.17.10-gentoo/kernel-x86_64-fedora.config' -O "$APPL_DIR"/distro/gentoo-fedora-x86_64.config
